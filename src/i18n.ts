...
const zh: Dict = {
  ...
  'modal.dateRaw': '原始值：{start} — {end}',
  'modal.dash': '—',
  'modal.consumeDays': '消耗假期天数：',
  'modal.daysValue': '{n} 天',
  'modal.autoExclude': '（已自动排除周末和公共假日）',
  'modal.crossYearTitle': '⚠️ 跨年假期，将按年份自动拆分：',
  'modal.byYearTitle': '按年份计入配额：',
  'modal.yearLabel': '{year}年：',
  'modal.tagCarryover': '结转 {n}天',
  'modal.tagContractual': '合同 {n}天',
  'modal.tagStatutory': '法定 {n}天',
...
const en: Dict = {
  ...
  'modal.dateRaw': 'Raw: {start} — {end}',
  'modal.dash': '—',
  'modal.consumeDays': 'Vacation days used:',
  'modal.daysValue': '{n} days',
  'modal.autoExclude': '(Weekends and public holidays auto-excluded)',
  'modal.crossYearTitle': '⚠️ Spans multiple years; will be split per year:',
  'modal.byYearTitle': 'Counted per year:',
  'modal.yearLabel': '{year}:',
  'modal.tagCarryover': 'Carry-over {n}d',
  'modal.tagContractual': 'Contractual {n}d',
  'modal.tagStatutory': 'Statutory {n}d',
