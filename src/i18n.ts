...
const zh: Dict = {
  ...
  'settings.importChoiceHint': '备份文件包含 {n} 条记录，请选择导入方式：',
  'settings.importMerge': '追加到现有记录',
  'settings.importReplace': '替换全部记录',
...
const en: Dict = {
  ...
  'settings.importChoiceHint': 'Backup contains {n} record(s). How do you want to import?',
  'settings.importMerge': 'Add to existing',
  'settings.importReplace': 'Replace all',
