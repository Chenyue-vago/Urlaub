...
const zh: Dict = {
  ...
  'settings.importMerge': '📥 追加导入',
  'settings.importReplace': '🗑️ 替换导入',
  'settings.importConfirm': '将把备份文件中的 {n} 条记录追加到现有数据上（不会删除任何现有记录）。继续吗？',
  'settings.importConfirmReplace': '将删除你当前所有的 {existing} 条记录，再导入备份中的 {n} 条记录。此操作不可撤销。继续吗？',
  'settings.importSuccess': '导入成功，已添加 {n} 条记录。',
  'settings.importReplaceSuccess': '替换导入成功，已添加 {n} 条记录。',
...
const en: Dict = {
  ...
  'settings.importMerge': '📥 Add to existing',
  'settings.importReplace': '🗑️ Replace all',
  'settings.importConfirm': 'This will add the {n} record(s) from the backup to your existing data (nothing is removed). Continue?',
  'settings.importConfirmReplace': 'This will DELETE your {existing} existing record(s) and replace them with the {n} record(s) from the backup. Cannot be undone. Continue?',
  'settings.importSuccess': 'Import successful, {n} record(s) added.',
  'settings.importReplaceSuccess': 'Replace successful, {n} record(s) imported.',
